...
## About 
Project 3 Udacity Android Developer Nandegree. The App queries TheMovieDb API to retrieve data using Retrofi. It is possible to sort the list by most popular and top rated movies.
